...
<script type="text/javascript">
                ...
                @foreach($ManualOrders as $ManualOrder)
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group col-sm">
                                ...
                                <textarea class="form-control  @if($errors->get('reciever_address')) is-invalid @endif" id="reciever_address[]"   name="reciever_address[]" placeholder="reciever_address" style="height:150px;" required>{{old('reciever_address')}}@if(isset($ManualOrder)){{trim($ManualOrder->reciever_address)}}@endif</textarea>
                        ...
                        <div class="col-sm-4"> 
                            ...
                            <div class="form-group col-sm">
                                ...
                                <input type="number" class="form-control @if($errors->get('cod_amount')) is-invalid @endif cod_amount"  value="{{old('cod_amount')}}@if(isset($ManualOrder)){{trim($ManualOrder->cod_amount)}}@endif" id="cod_amount[]"  name="cod_amount[]" placeholder="COD" readonly >
 ...
 <script type="text/javascript">
    ...
    {
        document.getElementsByClassName("fare")[index].value = '';
...
{  
    ...
    let price = document.getElementsByClassName("cod_amount")[index].value;
    $.ajax({
...
function onclickchangeadvancepayment(index)
{
    document.getElementsByClassName("advance_payment")[index].value = ''; 
}
