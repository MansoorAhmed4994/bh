                ...
                <tbody>
                	...
                	<tr>
                		<td colspan="2" rowspan="2" style="padding:5px; text-align:center;">
                			...
                			<img src="http://mnpcourier.com/mycod/assets/images/mnpLogo.png" alt="logo" width="125">
                			
                		</td>
                		<td colspan="3" rowspan="2" style="text-align:center;padding:5px;font-size:12px;">
                		    <img src="data:image/png;base64,<?php echo DNS1D::getBarcodePNG((string)$ManualOrder->consignment_id, 'C39') ?>" alt="barcode" style="width: 290px;height: 38px;"  />
                			<span class="notranslate"><p>{{$ManualOrder->consignment_id}}</p></span>
                        </td>
                    ...
                    <tr>
                        ...
                        <div class="mb-3"><img src="data:image/png;base64,<?php echo DNS2D::getBarcodePNG((string)$ManualOrder->consignment_id, 'QRCODE') ?>" alt="barcode" width="100"  />
                        </div></div>
                        </td>
                    ...
                    <tr>
                	<td colspan="2" style="font-size:16;px;text-align:center; font-weight:bold;">KHI To {{$ManualOrder->city}}</td>
                	...
                	<tr>
                		...
                		<td style="font-size:8px;text-align:center;padding-top:0px;padding-bottom:0px;">{{$ManualOrder->total_pieces}}</td>
                    </tr>
                    <tr>
