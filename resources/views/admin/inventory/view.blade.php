        ...
        <form id="update_form" name="update_form" enctype="multipart/form-data"method="post">
            ...
            <div class="row">
                <div class="form-group col-sm-3">
                    ...
                    <input type="text" class="form-control @if($errors->get('first_name')) is-invalid @endif" value="{{old('first_name')}} @if(isset($ManualOrder)) {{$ManualOrder->first_name}}  @endif" id="first_name"  value="{{old('first_name')}} @if(isset($ManualOrder)) {{$ManualOrder->first_name}}  @endif" name="first_name" placeholder="First Name" disabled>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input type="text" class="form-control @if($errors->get('last_name')) is-invalid @endif" value="{{old('last_name')}} @if(isset($ManualOrder)) {{$ManualOrder->last_name}}  @endif" id="last_name"  value="{{old('last_name')}} @if(isset($ManualOrder)) {{$ManualOrder->last_name}}  @endif" name="last_name" placeholder="First Name"  disabled>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input type="text" class="form-control @if($errors->get('number')) is-invalid @endif" value="{{old('number')}} @if(isset($ManualOrder)) {{$ManualOrder->number}}  @endif" id="number"  name="number" placeholder="number Number"  disabled>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input type="text" class="form-control @if($errors->get('whatsapp_number')) is-invalid @endif" value="{{old('whatsapp_number')}} @if(isset($ManualOrder)) {{$ManualOrder->number}}  @endif" id="whatsapp_number"  name="whatsapp_number" placeholder="Whatsapp number"  disabled>
            ...
            <div class="row">
                <div class="form-group col-sm-3">
                    ...
                    <textarea class="form-control" id="address @if($errors->get('address')) is-invalid @endif"   name="address" placeholder="address"  disabled>{{old('address')}}  @if(isset($ManualOrder)) {{$ManualOrder->address}}  @endif</textarea>
                    <small id="address_error" class="form-text text-danger">@if($errors->get('address')) {{$errors->first('address')}} @endif</small>
                </div>  
    
                <div class="form-group col-sm-3">
                    <label for="address">city</label>
                    <textarea class="form-control" id="city @if($errors->get('city')) is-invalid @endif"   name="city" placeholder="City"  disabled>{{old('city')}}  @if(isset($ManualOrder)) {{$ManualOrder->city}}  @endif</textarea>
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input type="text" class="form-control @if($errors->get('total_pieces')) is-invalid @endif" value="{{old('total_pieces')}} @if(isset($ManualOrder)) {{$ManualOrder->total_pieces}}  @endif" id="total_pieces"  name="total_pieces" placeholder="Total Pieces"  disabled>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input type="text" class="form-control @if($errors->get('weight')) is-invalid @endif" value="{{old('weight')}} @if(isset($ManualOrder)) {{$ManualOrder->weight}}  @endif" id="weight"  name="weight" placeholder="Weight (in kg)"  disabled>
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input type="text" class="form-control @if($errors->get('advance_payment')) is-invalid @endif" value="{{old('advance_payment')}} @if(isset($ManualOrder)) {{$ManualOrder->advance_payment}}  @endif" id="advance_payment"  name="advance_payment" placeholder="Advance Payment"  disabled>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <input type="text" class="form-control @if($errors->get('cod_amount')) is-invalid @endif" value="{{old('cod_amount')}} @if(isset($ManualOrder)) {{$ManualOrder->cod_amount}}  @endif" id="cod_amount"  name="cod_amount" placeholder="COD"  disabled>
